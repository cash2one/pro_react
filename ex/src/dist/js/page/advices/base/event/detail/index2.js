...
define(['mods', paths.rcn.util + '/rest.js', paths.ex.page + '/advices/base/articles/actions.js', paths.ex.page + '/advices/base/articles/filters.js', paths.ex.page + '/advices/base/articles/while.js', paths.ex.page + '/advices/base/articles/order.js', paths.ex.page + '/advices/base/articles/article-list.js', paths.ex.page + '/advices/base/articles/search.js', paths.ex.page + '/advices/base/articles/cur-filter.js', paths.rcn.comps + '/modal/index.js', paths.rcn.comps + '/loader.js'], function (mods, R, Actions, Filters, While, Order, ArtList, Search, CurFilter, Modal, Loader) {
	...
	var _Actions = Actions('articles_events');
	...
	var Articles = React.createClass({
		...
		componentWillUnmount: function componentWillUnmount() {
			$('.frame-body-right').removeClass('v2');
			...
			return React.createElement(
					...
					React.createElement(
						...
						React.createElement(ArtList, {
							...
							putDepend: function putDepend(uuid) {
								return dispatch(dependModalTog(true, uuid));
							} }),
						React.createElement(
							'div',
				...
				React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'head' },
						React.createElement(CurFilter, { type: 'event', defaultParams: defaultParams, tags: selected_tags, deleteClick: function deleteClick(key, value) {
				...
				React.createElement(
					Modal,
					{ show: dependModalShow, title: '温馨提示', dismiss: function dismiss() {
							return dispatch(dependModalTog(false));
						}, confirm: function confirm() {
							return dispatch(putDepend());
						} },
					React.createElement(
						'div',
						{ className: 'm-tip' },
