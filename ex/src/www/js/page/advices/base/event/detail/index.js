define([
	...
	var Articles = React.createClass({
		...
		render(){
			const {dispatch, filters, filters_selected, queryParams, paramsMirror, selected_tags, defaultParams, articles, reportSelectData, eventSelectData, articlesCount, location, dependModalShow, loading, togMore} = this.props;
			...
			return (
				<div className="advices-base2">
					...
					<section className="filter-part">
						<div className="head">
							<CurFilter type="event" defaultParams={defaultParams} tags={selected_tags} deleteClick={(key, value) => sync(key, value)} clearAll={(a1,a2,res) => sync(a1,a2,res)} />
						</div>
						<div className="bd">
							<Filters
								data={filters.data}
