 ...
 */
  ...
  */
	...
	$.validator.addMethod("first_en_num", function (value, element) {
		return this.optional(element) || /^[a-z][a-z0-9]{1,}$/.test(value);
	}, "请填写小写字母或者数字（首字母须为小写字母）");

	$.validator.addMethod("telephone_rule", function (value, element) {
