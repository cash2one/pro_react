...
require([
	"mods",
	'http://info.puzhizhuhai.com/js/mobile/detail.js',
], function(mods, SpreadDetail){
	...
	ReactDOM.render(
		<SpreadDetail tp={mediaType} companyId={companyId} userToken={userToken} eventId={eventId} />
