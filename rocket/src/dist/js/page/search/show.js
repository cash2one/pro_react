...
require(["mods", "Frame", "Reducer_Frame", paths.rcn.page + '/search/show.js', paths.rcn.page + '/search/edit.js'], function (mods, Frame, Reducer_Frame, Manager, Viewer, Company, CompanyWelcome) {
